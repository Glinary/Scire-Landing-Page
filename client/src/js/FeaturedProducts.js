        ...
        <div className="border-2 border-emerald-900 m-10 rounded-lg">
            ...
            <div className="px-14 mb-14">
                <div className="flex border border-emerald-900 rounded-md mb-8 h-full px-8 py-4 space-x-6"> {/* Product 1 */}
                    <img src={oryol_1} alt="oryol-1" className="basis-1/4 object-cover h-full overflow-hidden p-4 border border-[#aaaaaa]"></img>
                    <img src={oryol_2} alt="oryol-2" className="basis-1/4 object-cover h-full overflow-hidden p-4 border border-[#aaaaaa]"></img>
                    <div className="basis-1/2 h-full">
                        ...
                        <p className="text-md">Ingredients: Aqua, Palm Oil, Coconut Oil, Olive Oil, Lye, Aloe Vera, Elemi Oil, Salicylic Acid, Elemi Resinoid</p>
                    </div>
                </div>
                
                <div className="flex border border-emerald-900 rounded-md mb-8 h-full px-8 py-4 space-x-6"> {/* Product 2 */}
                    <img src={magayon_1} alt="magayon-1" className="basis-1/4 object-cover h-full overflow-hidden p-4 border border-[#aaaaaa]"></img>
                    <img src={magayon_2} alt="magayon-2" className="basis-1/4 object-cover h-full overflow-hidden p-4 border border-[#aaaaaa]"></img>
                    <div className="basis-1/2 h-full">
                ...
                <div className="flex border border-emerald-900 rounded-md h-full px-8 py-4 space-x-6"> {/* Product 3 */}
                    <img src={handyong_1} alt="handyong-1" className="basis-1/4 object-cover h-full overflow-hidden p-4 border border-[#aaaaaa]"></img>
                    <img src={handyong_2} alt="handyong-2" className="basis-1/4 object-cover h-full overflow-hidden p-4 border border-[#aaaaaa]"></img>
                    <div className="basis-1/2 h-full">
                        <p className="text-2xl font-bold pb-1">Handyong</p>
                        <p className="text-lg pb-12">Elemi Fresh Bar Soap</p>
                        <p className="text-md">Firming, Lifting, Refreshing, Anti-bacterial, Hydrating</p>
